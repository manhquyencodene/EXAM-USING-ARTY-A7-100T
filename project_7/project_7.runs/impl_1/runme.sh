...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_7/project_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_CLOCK.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_CLOCK.tcl -notrace
