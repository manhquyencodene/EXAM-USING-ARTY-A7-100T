...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_CLOCK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_CLOCK.tcl
