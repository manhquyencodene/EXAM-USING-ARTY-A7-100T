...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_CT_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SW_CT_LED.tcl -notrace
