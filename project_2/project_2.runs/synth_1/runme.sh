...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_CT_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SW_CT_LED.tcl
