...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PUSH_BUTTON_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PUSH_BUTTON_LED.tcl
