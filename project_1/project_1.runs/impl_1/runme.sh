...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PUSH_BUTTON_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PUSH_BUTTON_LED.tcl -notrace
