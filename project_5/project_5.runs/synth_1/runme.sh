...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_RGB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SW_RGB.tcl
