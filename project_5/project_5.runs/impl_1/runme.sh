...
HD_PWD='D:/Xilinx/ARTY_A7/lamquen/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_RGB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SW_RGB.tcl -notrace
